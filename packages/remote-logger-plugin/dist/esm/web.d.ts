...
import type { Options, CapacitorRemoteLoggerPlugin } from './definitions';
export declare class RemoteLoggerWeb extends WebPlugin implements CapacitorRemoteLoggerPlugin {
    private static that;
