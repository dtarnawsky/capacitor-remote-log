var capacitorCapacitorRemoteLogger = (function (exports, core) {
    ...
    const CapacitorRemoteLogger$1 = core.registerPlugin('CapacitorRemoteLogger', {
        web: () => Promise.resolve().then(function () { return web; }).then(m => new m.RemoteLoggerWeb()),
        ios: () => Promise.resolve().then(function () { return web; }).then(m => new m.RemoteLoggerWeb()),
        android: () => Promise.resolve().then(function () { return web; }).then(m => new m.RemoteLoggerWeb()),
    });
